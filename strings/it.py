...
conversation_after_start = "Ciao!\n" \
                           ...
                           "Se ne trovate, potete collaborare per risolverli, descrivendo cosa è successo"
...
conversation_cart_actions = "<i>Aggiungi Spotify Premium al carrello premendo il pulsante Aggiungi sotto." \
                            "Quando avrai terminato, torna a questo messaggio e" \
                            " premi il tasto Fatto. Nella fase successiva inserisci il tuo account Spotify</i>"
...
# Order product: notes?
ask_order_notes = "✅ Inserisci ora il tuo account Spotify \n" \
                  "Una volta completato l'ordine il tuo account diventerà Premium\n" \
                  "\n"\
                  "<i>Invia un messaggio con il tuo account Spotify, oppure scrivi 'crea account'" \
                  " e creeremo noi il tuo account Premium.</i>"
