...
conversation_cart_actions = "<i>Add Spotify Premium to your cart by pressing the Add button below." \
                            "When you're done, return to this message and" \
                            " press the Done button. In the next step enter your Spotify account</i>"
...
# Order product: notes?
ask_order_notes = "✅ Please enter your Spotify account \n" \
                  "Once the order is completed your account will become Premium\n" \
                  "\n"\
                  "<i>Send a message with your Spotify account, or type 'create account'" \
                  " and we'll create your Premium account.</i>"
